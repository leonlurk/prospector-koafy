...
// Context Providers
import { TemporaryAgentProvider } from './context/TemporaryAgentContext';
    ...
    <TemporaryAgentProvider>
      <MainLayout>
        <Routes>  {/* Usar Routes para definir las rutas */}
          ...
          {/* --- Ruta para Agente Temporal (Antes de guardar) --- */}
          <Route path="/agents/temp" element={<AgentDetailPage />}>
